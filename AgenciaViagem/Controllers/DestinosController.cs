...
namespace AgenciaViagem.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public DestinosController(BancoDeDados context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdDestino,LocalDestino,DataIda,QtdPassageiros")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDestino,LocalDestino,DataIda,QtdPassageiros")] Destino destino)
        {
